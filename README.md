...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/orange-wind-663b
```

A live public deployment of this template is available at [https://orange-wind-663b.templates.workers.dev](https://orange-wind-663b.templates.workers.dev)
